...
export function HtTable({ data, onEdit, onRefresh }: { data: any[], onEdit: (item: any) => void, onRefresh: () => void }) {
  ...
  const viewFields: ViewField[] = [
    ...
    { label: 'Penerima', key: 'pic_name' },
    { label: 'Barang (Brand)', key: 'brand' },
    { label: 'Tipe', key: 'type' },
    ...
    { label: 'Divisi / Project', key: 'division' },
    { label: 'Lokasi', key: 'branch' },
      ...
      <div className="overflow-auto max-h-[calc(100vh-16rem)] relative">
        ...
        <TableHeader className="sticky top-0 bg-white/95 backdrop-blur z-10 shadow-sm">
          <TableRow>
            ...
            <SortableTableHead label="Penerima" sortKey="pic_name" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['pic_name']} onFilterChange={setColumnFilter} data={data} />
            <SortableTableHead label="Barang" sortKey="brand" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['brand']} onFilterChange={setColumnFilter} data={data} />
            ...
            <SortableTableHead label="Handover Date" sortKey="handover_date" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['handover_date']} onFilterChange={setColumnFilter} data={data} />
            <SortableTableHead label="Return Date" sortKey="return_date" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['return_date']} onFilterChange={setColumnFilter} data={data} />
            ...
            <SortableTableHead label="Divisi / Project" sortKey="division" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['division']} onFilterChange={setColumnFilter} data={data} />
            <SortableTableHead label="Lokasi" sortKey="branch" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['branch']} onFilterChange={setColumnFilter} data={data} />
        ...
        <TableBody>
          {paginatedData.map((item: any) => (
            <React.Fragment key={item.id}>
              ...
              <TableCell className="whitespace-nowrap max-w-[200px] truncate">{item.notes || "-"}</TableCell>
  <TableCell className="sticky right-0 bg-white/90 backdrop-blur shadow-[-4px_0_12px_rgba(0,0,0,0.02)] z-10">
                <div className="flex gap-1 justify-center">
                  <AssetTransferActions item={item} tableName="hts" onSuccess={onRefresh} />
