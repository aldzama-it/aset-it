      ...
      <Table className="whitespace-nowrap">
        <TableHeader>
          <TableRow>
            ...
            <SortableTableHead label="Quantity" sortKey="quantity" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['quantity']} onFilterChange={setColumnFilter} data={data} />
            ...
            <SortableTableHead label="Form Serah Terima" sortKey="handover_form" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['handover_form']} onFilterChange={setColumnFilter} data={data} />
            <SortableTableHead label="Form Pengembalian" sortKey="return_form" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['return_form']} onFilterChange={setColumnFilter} data={data} />
        ...
        <TableBody>
          {processedData.map((item: any) => (
            <React.Fragment key={item.id}>
              ...
              <TableCell className="whitespace-nowrap">{item.handover_form ? <a href={item.handover_form} target="_blank" className="text-blue-600 hover:underline">Link</a> : '-'}</TableCell>
              <TableCell className="whitespace-nowrap">{item.return_form ? <a href={item.return_form} target="_blank" className="text-blue-600 hover:underline">Link</a> : '-'}</TableCell>
