      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <SortableTableHead label="Departmen" sortKey="department" currentSort={sortConfig} onRequestSort={requestSort} currentFilter={columnFilters['department']} onFilterChange={setColumnFilter}  data={data} />
