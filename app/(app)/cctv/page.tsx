...
import { Plus, Download, Video, AlertTriangle, CheckCircle2 } from 'lucide-react'
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto pb-2 sm:pb-0">
          <Button variant="outline" onClick={() => exportToExcel(data, 'Data_CCTV')} className="shrink-0">
      ...
      <CctvTable data={filteredData} onEdit={(item) => { setEditItem(item); setFormOpen(true) }} onRefresh={fetchData} />
