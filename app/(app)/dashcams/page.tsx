  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 max-w-xl">
        ...
        <Button variant="outline" onClick={() => exportToExcel(data, 'Data_Dashcam')}>
          <Download className="w-4 h-4 md:mr-2" /> <span className="hidden md:inline">Export</span>
        </Button>
      </div>
      <DashcamTable data={data} onEdit={(item) => { setEditItem(item); setFormOpen(true) }} onRefresh={fetchData} />
