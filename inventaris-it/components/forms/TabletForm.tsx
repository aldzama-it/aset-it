  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{item ? 'Edit' : 'Tambah'} Tablet</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label className="capitalize">storage gb</Label>
              <Input type="text" {...register('storage_gb')} />
            </div>
            <div className="space-y-2">
              <Label className="capitalize">ram gb</Label>
              <Input type="text" {...register('ram_gb')} />
            </div>
            <div className="space-y-2">
